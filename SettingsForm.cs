...
namespace SecureNotes
{
    public partial class SettingsForm : Form
    {
        ...
        private void InitializeModernUI()
        {
            ...
            {
                Text = LocalizationManager.Get("switch_account"),
                Location = new Point(padding, y),
        ...
        private void CmbLanguage_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cmbLanguage.SelectedItem is LanguageItem item)
            {
                ...
                btnSwitchAccount.Text = LocalizationManager.Get("switch_account");
        ...
        private void BtnSwitchAccount_Click(object sender, EventArgs e)
        {
            var result = MessageBox.Show(
                ...
                LocalizationManager.Get("switch_account"),
